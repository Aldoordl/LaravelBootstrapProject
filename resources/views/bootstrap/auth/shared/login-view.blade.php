        ...
        <div class="container px-5">
            ...
            <div class="bg-light rounded-4 py-5 px-4 px-md-5">
                <div class="text-center mb-5">
                    <div class="feature bg-primary bg-gradient-primary-to-secondary text-white rounded-3 mb-3"><i class="bi bi-door-open"></i></div>
                    <h1 class="fw-bolder">Sign In</h1>
                    <p class="lead fw-normal text-muted mb-0">Not registred yet? <a href="{{ route('register') }}" style="text-decoration: none">Sign up</a></p>
                </div>
